...
from feeds.metar_conditions import parse_conditions
...
class MetarFeed:
    ...
    def _reduce(self, icao, rows, tz, now_utc):
        ...
        return {
            ...
            # effect can be measured against real outcomes; gates nothing.
            "conditions": parse_conditions(rows, self._obs_time, now_utc),
        }
